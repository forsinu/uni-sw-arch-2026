...
class EnvHandler(BaseSettings):
    ...
    ROUTING_LOGGER_NAME: str = "auth-service.routing"
    ...
    RT_COOKIE_NAME: str = "rt"
    RT_COOKIE_SAMESITE: Literal["strict", "lax", "none"] = "lax"
    RT_COOKIE_SECURE: bool = True
    ...
    DB_LOGGER_NAME: str = "auth-service.database"
    ...
    APP_LOGGER_NAME: str = "auth-service"
