...
export interface UpdateFederationMemberRequest {
  fedRole?: FederationMemberBackendRole;
  teamId?: string | null;
  firstName?: string;
  lastName?: string;
...
export interface UpdateSwimmingTeamRequest {
  name?: string;
  shortName?: string | null;
  isActive?: boolean;
}
...
export interface UpdateSwimmingPoolRequest extends Partial<CreateSwimmingPoolRequest> {
  isActive?: boolean;
}
